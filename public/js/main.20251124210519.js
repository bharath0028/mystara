    ...
    [0], {
        ...
        kpGR: function(e, t, o) {
            ...
            var Z = o("xC2a"),
                    ...
                    return C(t, e), v(t, [{
                        ...
                        value: function() {
                            ...
                            var n = new X.a({
                                ...
                                a = new q.b(1, 1),
                                r = new V.a(a, n);
                            r.scale.set(600, 600, 1), r.position.set(0, 0, -250), this.add(r);
                            var diamondTex = new Z.a().load("diamond.png");
                            var diamondMat1 = new X.a({map: diamondTex, transparent: !0}),
                                diamondGeo1 = new q.b(1, 1),
                                diamond1 = new V.a(diamondGeo1, diamondMat1);
                            diamond1.scale.set(80, 80, 1), diamond1.position.set(-400, 250, -100), diamond1.rotation.z = 0.3, this.add(diamond1);
                            var diamondMat2 = new X.a({map: diamondTex, transparent: !0}),
                                diamondGeo2 = new q.b(1, 1),
                                diamond2 = new V.a(diamondGeo2, diamondMat2);
                            diamond2.scale.set(60, 60, 1), diamond2.position.set(350, -200, -150), diamond2.rotation.z = -0.5, this.add(diamond2);
                            var diamondMat3 = new X.a({map: diamondTex, transparent: !0}),
                                diamondGeo3 = new q.b(1, 1),
                                diamond3 = new V.a(diamondGeo3, diamondMat3);
                            diamond3.scale.set(70, 70, 1), diamond3.position.set(-200, -300, 0), diamond3.rotation.z = 0.8, this.add(diamond3);
                            this.addIntroBadge()
                        }
                    }, {
                        key: "addIntroBadge",
                ...
                fe = {
                    jan: ["woman-bicycle.mp4", "bottle.png", "cursor.mp4", "dark.mp4", "houseofplants.mp4.mp4", "iceland-orig.mp4", "bottle.mp4", "nike.mp4", "woman1.jpeg", "bottle1.gif", "woman2.jpeg"],
                    feb: ["woman3.mp4", "bottle3.mp4", "ezgif.com-gif-to-mp4 (12).mp4", "fila_dribbble.jpg", "fullsize.mp4", "houseofplants_ar.mp4", "nz.jpg", "surf_fullsize.mp4", "surf_mob_fullsize.mp4"],
                    ...
                    jul: ["05.jpg", "6oclockgin (2).mp4", "melt].jpg", "luke.jpg", "natural_wonders.mp4.mp4", "IMG_9709 2.jpg"],
                    aug: ["bottle3.mp4", "ezgif.com-gif-to-mp4 (6).mp4", "aug-nala.jpg", "ezgif.com-gif-to-mp4 (7).mp4", "1061670554.mp4.mp4", "boatparty.jpg", "ezgif.com-gif-to-mp4 (8).mp4", "cssda-wotd.jpg", "ezgif.com-gif-to-mp4 (9).mp4", "shapes___lighting.jpg"],
                    ...
                    return M(e, [{
                        ...
                        value: function() {
                            ...
                            this.renderer = new I.a({
                                antialias: !0,
                                alpha: !0
                            }), this.renderer.setPixelRatio(this.c.dpr), this.renderer.setSize(this.c.size.w, this.c.size.h), document.body.appendChild(this.renderer.domElement), this.preventPullToRefresh(), this.scene = new D.a, this.scene.background = new W.a(12437705), this.scene.fog = new F.a(12437705, 1400, 2e3), this.scene.scale.set(this.c.globalScale, this.c.globalScale, 1);
                            var o = 800,
